...
public:
	...
	/**
	 * @param InAddress  서비스와 연관된 NetAddress (서버: 바인드 주소 / 클라: 연결 대상)
	 * @param InFactory  Session 생성 팩토리 (nullptr 금지)
	 */
	Service(NetAddress InAddress, SessionFactory InFactory);
	virtual ~Service();
